...
function appStart() {
  const displayGameover = () => {
    ...
    div.style =
      "display:flex; justify-content:center; align-items:center; position:absolute; top:30vh; left:40.5vw; background-color:red; width:300px; height:300px; font-size:large; font-weight:bold;";
